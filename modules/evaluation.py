...
# %%
def get_evaluation(timetable:Timetable, students:list[Student], q_intervenants:Q_Intervenants, mode='itv-driven')->None:
    ...
    overall_ratio_itv_visited       = round(overall_ratio_itv_visited/len(tmp_students),3)
